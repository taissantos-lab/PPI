...
Sei o básico, mas ainda tenho dificuldade para fazer diagramas e organizar os
dados corretamente.
5. Em quais atividades prefere colaborar: pesquisar, escutar, modelar, programar,
testar ou apresentar?
Prefiro pesquisar e testar, pois ainda não tenho muita experiência com programação
e modelagem.
6. Qual dos dois eixos despertou mais interesse? Por quê?
O Eixo 2 – Permanência e Evasão Escolar, porque achei interessante entender os
dados sobre os estudantes e descobrir como a tecnologia pode ajudar nesse
problema.
7. O que você gostaria de aprender durante o projeto?
Gostaria de aprender mais sobre programação, banco de dados e como
desenvolver um projeto de software na prática.
8. Em que conteúdo acredita precisar de mais ajuda?
Preciso de mais ajuda principalmente em programação, banco de dados e criação
...
Pessoas ou grupos afetados: Participantes e organizadores/monitores.
Consequência ou sintoma: Formação de espera e interrupção momentânea do fluxo das atividades.
...
Pessoas ou grupos afetados: Participantes e equipe responsável pelas atividades.
Consequência ou sintoma: Mais tempo para responder às dúvidas e necessidade de repetir ou confirmar informações.
Informações ou dados envolvidos: Horários, locais, responsáveis e detalhes das atividades.
...
3. Contexto:
A investigação será sobre o registro e a consulta de memórias quilombolas.

4. Público principal:
Pessoas que fazem parte das comunidades quilombolas e que vivenciam ou possuem essas memórias.

5. Partes interessadas:
Pessoas da comunidade e pessoas envolvidas com o registro, a preservação e a consulta dessas memórias.

6. Problema provisório:
Os registros de memórias quilombolas podem estar dispersos ou apresentar autoria e autorização pouco claras.

7. Objetivo provisório:
Compreender o registro e a consulta das memórias quilombolas, respeitando a decisão da comunidade.

8. Limite inicial:
Nesta etapa, não serão coletados relatos reais.

9. Hipótese a validar:
Ainda é necessário investigar como os registros de memórias quilombolas são organizados e quais são as condições para sua consulta.

10. Lacuna mais importante:
Ainda não sabemos como os registros estão organizados e como são definidas a autoria, a autorização e a consulta dessas memórias.
